...
void testApp::setup(){
    ...
    string name = "solarfly";
    string description = "data reading";
    
    spacebrew.addPublish("solarfly", Spacebrew::TYPE_BOOLEAN);
    spacebrew.addSubscribe("bSendSerialMessage", Spacebrew::TYPE_BOOLEAN); //"boolean" ); // just typing "boolean" also works
...
void testApp::mousePressed(int x, int y, int button){
    ...
    spacebrew.sendBoolean("solarfly", true);
}

//--------------------------------------------------------------
void testApp::mouseReleased(int x, int y, int button){
    bSendSerialMessage=false;
    spacebrew.sendBoolean("solarfly", false);
